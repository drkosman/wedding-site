...
- [Architecture and workflows](architecture.md) — component boundaries, frontend and API structure, external services, and the invitation, RSVP, content, and admin flows.
